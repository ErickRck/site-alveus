...
<img src="<?php echo base_url() . 'assets/images/uploads/'. $row -> image; ?>" width="200px">
                   ...
                   <td>
                  <a href="<?php echo base_url('Admin/Crud/edit_service') ?>/<?php echo $row->id; ?>"><i class="fa fa-edit"></i></a>
                  <a href="<?php echo base_url('Admin/Crud/delete_service') ?>/<?php echo $row->id; ?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
               <?php } ?>
              </table>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          ...
          <form enctype="multipart/form-data" action="<?php echo base_url('Admin/Crud/insert_validation_service'); ?>" method="post"> 
          <span class="text-danger"><?php echo $this->session->flashdata("error"); ?></span> 
            ...
            <div class="input-group" style="width: 100%;">
                ...
                <div class="input-group" style="width: 100%;">
                  ...
                  <textarea name="description" type="text" style="height: 140px"  class="form-control" placeholder="Commentaire ...">
