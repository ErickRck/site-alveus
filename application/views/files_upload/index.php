...
<div class="container">
	<div class="row ">			
		<form enctype="multipart/form-data" action="<?php echo base_url('Files_upload'); ?>" method="post">
    ...
    <div class="row">
		<div class="gallery">
			<ul>
				...
				<li>
					<img width="200" height="200" src="<?php echo base_url('assets/fonts/'.$file['file_name']); ?>" alt="" >
